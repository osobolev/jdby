...
// todo: move away to standard GlobalContext implementation!!!
public final class SqlParameters {

    private static JDBCType jdbcType(Class<?> type) {
    ...
    public static SqlParameter create(Class<?> type, Object value) {
        JDBCType jdbcType = jdbcType(type); // todo: make configurable
        if (jdbcType == null)
